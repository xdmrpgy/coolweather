package com.pgy.android.coolweather.db;
...
public class CoolWeatherDB {
	...
	//load cities under provinceId from db
	...
	//load countries under cityId from db
	public List<Country> loadCountries(int cityId) {
		List<Country> list = new ArrayList<Country>();
		Cursor cursor = db.query("Country",
				null, "country_id = ?", new String[] {String.valueOf(cityId)}, null, null, null);
